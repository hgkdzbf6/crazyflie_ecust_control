...
int main(int argc, char **argv)
{
  ...
  n.param("enable_logging", enable_logging, false);
  n.param("enable_parameters", enable_parameters, false);
  n.param("use_ros_time", use_ros_time, true);
  n.param("enable_logging_imu", enable_logging_imu, false);
  ...
  n.param("enable_logging_battery", enable_logging_battery, false);
